                ...
                <div class="variations">
                  ${this.config.showMonthRatio 
                    ...
                    <span class="variations-linky">
                      ...
                      <div class="tooltip">
                      ${Math.round(attributes.monthly_evolution)}<span class="unit"> %</span><br><span class="previous-month">vs ${this.previousMonth()}</span>
                  ...
                  ${this.config.showCurrentMonthRatio 
                    ...
                    <span class="variations-linky">
                      ...
                      <div class="tooltip">
                      ${Math.round(attributes.current_month_evolution)}<span class="unit"> %</span><br><span class="current-month">vs ${this.currentMonth()}</span>
                  ...
                  ${this.config.showWeekRatio 
                    ...
                    <span class="variations-linky">
                        ...
                        <div class="tooltip">
                        ${Math.round(attributes.current_week_evolution)}<span class="unit"> %</span><br><span class="previous-month">vs ${this.weekPreviousYear()}</span>
                  ...
                  ${this.config.showYesterdayRatio
                    ...
                    <span class="variations-linky">
                        ...
                        <div class="tooltip">
                        ${Math.round(attributes.yesterday_evolution)}<span class="unit"> %</span><br><span class="previous-month">vs ${this.yesterdayPreviousYear()}</span>
